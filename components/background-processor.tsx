...
const BackgroundProcessor = {
  ...
  getOptimalProcessingSettings() {
    ...
    return {
      ...
      internalResolution: (isMobile || isLowEndDevice ? "low" : "medium") as BodyPixInternalResolution,
    ...
    try {
      ...
      if (net) {
        try {
          ...
          console.log(
            `Person pixels: ${personPixels}/${data.length} (${((personPixels / data.length) * 100).toFixed(1)}%)`,
          )
          ...
          if (backgroundImageRef.current) {
            ...
            outputCtx.drawImage(bgImg, 0, 0, bgImg.width, bgImg.height, offsetX, offsetY, drawWidth, drawHeight)
          } else {
          ...
          outputCtx.drawImage(tempCanvas, 0, 0, width, height, 0, 0, outputCanvas.width, outputCanvas.height)
